                  ...
                  <div className="grid grid-cols-3 gap-5 ">
                    ...
                    <div className="col-span-2">
                      ...
                      <p className="text-sm text-slate-600">
                        Our best-selling services include cutting-edge web and
                        mobile app development, designed to drive success and
                        user engagement. From iOS apps to cloud solutions, we
                        provide tailored development services that meet diverse
                        business needs.
                      </p>
              ...
              <div className="flex items-center gap-4">
                ...
                <li>
                  <div>
                    ...
                    <p className="text-lg">
                      {" "}
                      <a href="tel:+91123456789">+977-9846966350</a>
                    </p>
                  </div>
                </li>
              </div>
