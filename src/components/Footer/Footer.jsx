      ...
      <section className="mx-auto max-w-[1200px] text-white">
        <div className=" grid py-5 md:grid-cols-3">
          <div className=" px-4 py-8 ">
            ...
            <p className="">
            CozWeb is a cutting-edge software development company focused on creating innovative, high-performance apps that engage users and set industry trends.{" "}
            </p>
            <br />
